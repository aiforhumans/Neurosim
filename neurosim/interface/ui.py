...
agent manager and keeps session state isolated per user.
"""
...
from neurosim.interface.character_editor import build_character_editor
from neurosim.interface.visualization import build_visualisation, create_emotion_plot
...
def create_app(agent_manager: AgentManager) -> gr.Blocks:
    ...
    def respond(user_message: str, chat_history: list) -> tuple:
        ...
        # Append new messages to chat history for display
